...
import { UpdateFeedContent, DeleteFeedContent } from "@/features/feed-contents";
import { FeedContent } from "@/entities";
import {
  Table,
  TableBody,
  TableCell,
          ...
          <TableBody>
            {dataContents?.map((content) => (
              <FeedContent
                ...
                content={content}
                updateFeature={
                  <UpdateFeedContent updateContentId={content.id} />
                }
                deleteFeature={
                  <DeleteFeedContent deleteContentId={content.id} />
                }
              />
            ))}
          </TableBody>
